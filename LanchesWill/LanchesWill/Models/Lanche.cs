...
namespace LanchesWill.Models
{
    ...
    public class Lanche
    {
        ...
        [Display(Name = "Descriação curta do Lanche")]
        [MinLength(20, ErrorMessage = "Descrição curta deve ter no mínimo {1} caracteres")]
        [MaxLength(200, ErrorMessage = "Descrição curta deve ter no máximo {1} caracteres")]
        public string DescricaoCurta { get; set; }

        [Required(ErrorMessage = "O descrição do lanche deve ser informada")]
        [Display(Name = "Descrição detalhada do Lanche")]
        [MinLength(20, ErrorMessage = "Descrição detalhada deve ter no mínimo {1} caracteres")]
        [MaxLength(400, ErrorMessage = "Descrição detalhada deve ter no máximo {1} caracteres")]
        ...
        [Display(Name = "Imagem Normal do Lanche")]
        [StringLength(200, ErrorMessage =" O {0} deve ter no máximo {1} caracteres")] 
        public string ImagemUrl { get; set; }

        [Display(Name = "Imagem curta do Lanche")]
        [StringLength(200, ErrorMessage = " O {0} deve ter no máximo {1} caracteres")]
        public string ImagemThumbnailUrl { get; set; }

        [Display(Name = "Preferido ?")]
        public bool IsLanchePreferio { get; set; }
